...
export const TodayPill: React.FC<TodayPillProps> = ({
  ...
  return (
    <button
      ...
      className="fixed bottom-20 left-1/2 -translate-x-1/2 bg-ink text-cream px-4 py-2.5 font-mono text-[11px] tracking-[0.1em] uppercase z-30 shadow-[0_8px_24px_rgba(0,0,0,0.2)] flex items-center gap-2 cursor-pointer border-none"
    >
